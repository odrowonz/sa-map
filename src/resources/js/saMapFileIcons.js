/** Согласовано с config/sa_map/attachment_file_icons.php и App\Support\AttachmentFileIcon */
...
/**
 * Маленькая иконка типа файла (vscode-icons CDN) для вставки в Markdown рядом со ссылкой.
 */
export function fileIconImgHtml(att) {
